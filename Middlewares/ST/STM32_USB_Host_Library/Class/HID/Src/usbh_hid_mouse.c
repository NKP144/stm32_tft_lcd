...
/* Access button 4 state. */
static const HID_Report_ItemTypedef prop_b4 =
{
  (uint8_t *)(void *)mouse_report_data + 1, /*data*/
  1,     /*size*/
  3,     /*shift*/
...
/* Access button 5 state. */
static const HID_Report_ItemTypedef prop_b5 =
{
  (uint8_t *)(void *)mouse_report_data + 1, /*data*/
  1,     /*size*/
  4,     /*shift*/
...
USBH_StatusTypeDef USBH_HID_MouseInit(USBH_HandleTypeDef *phost)
{
  ...
  mouse_info.buttons[3] = 0U;
  mouse_info.buttons[4] = 0U;
  mouse_info.wheel = 0;
...
static USBH_StatusTypeDef USBH_HID_MouseDecode(USBH_HandleTypeDef *phost)
{
  ...
  if (USBH_HID_FifoRead(&HID_Handle->fifo, &mouse_report_data, HID_Handle->length) ==  HID_Handle->length)
  {
    ...
    mouse_info.buttons[3] = (uint8_t)HID_ReadItem((HID_Report_ItemTypedef *) &prop_b4, 0U);
    mouse_info.buttons[4] = (uint8_t)HID_ReadItem((HID_Report_ItemTypedef *) &prop_b5, 0U);

    mouse_info.wheel = (uint8_t)HID_ReadItem((HID_Report_ItemTypedef *) &prop_wheel, 0U);
